...
rm -Rf ./*
cmake -DCMAKE_INSTALL_PREFIX=$INSTALL_PATH -DCMAKE_C_COMPILER=$INSTALL_PATH/bin/clang -DCMAKE_CXX_COMPILER=$INSTALL_PATH/bin/clang++ -DCMAKE_C_FLAGS="$RV_CFLAGS" -DCMAKE_CXX_FLAGS="$RV_CXXFLAGS" -DLIBOMP_ARCH=riscv64 ../openmp
make -j$MAX_THREADS
make install
